...
class TextCommandRequest(BaseModel):
    ...
    account_id: str | None = Field(
        default=None,
        alias="accountId",
        description="Account id generated by .NET backend.",
    )
    audio_url: str | None = Field(
        default=None,
        alias="audioUrl",
        description="Optional audio URL. If not provided, sidecar auto-generates from filename or voice/{accountId}/path.",
    )
